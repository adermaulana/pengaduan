...
<body>
    ...
    <div class="container-fluid nav-bar bg-light">
        <nav class="navbar navbar-expand-lg navbar-light bg-white p-3 py-lg-0 px-lg-4">
            <a href="" class="navbar-brand d-flex align-items-center m-0 p-0 d-lg-none">
                <h1 class="text-primary m-0">Pengaduan</h1>
            </a>
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <div class="navbar-nav me-auto">
                    ...
                    <a href="login.php" class="nav-item nav-link">Kontak</a>
                </div>
    ...
    <div class="container-fluid p-0 mb-5">
        ...
        <div class="owl-carousel-item position-relative">
            <img class="img-fluid" src="assets/home/img/masyarakat2.jpg" alt="">
            <div class="position-absolute top-0 start-0 w-100 h-100 d-flex align-items-center" style="background: rgba(0, 0, 0, .4);">
                <div class="container">
                    <div class="row justify-content-start">
                        <div class="col-10 col-lg-8">
                            <h5 class="text-white text-uppercase mb-3 animated slideInDown">Layanan Pengaduan Masyarakat</h5>
                            <h1 class="display-3 text-white animated slideInDown mb-4">Sampaikan Pengaduan Anda dengan Mudah dan Cepat</h1>
                            <p class="fs-5 fw-medium text-white mb-4 pb-2">Kami siap menerima dan menangani pengaduan Anda terkait layanan publik. Pastikan suara Anda didengar untuk kemajuan bersama.</p>
                            <a href="" class="btn btn-primary py-md-3 px-md-5 me-3 animated slideInLeft">Baca Selengkapnya</a>
                            <a href="pengaduan.php" class="btn btn-secondary py-md-3 px-md-5 animated slideInRight">Kirim Pengaduan</a>
                        </div>
                    </div>
                </div>
            </div>
