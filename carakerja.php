    ...
    <div class="container">
        <div class="row g-4">
            <div class="col-md-12 wow fadeInUp" data-wow-delay="0.1s">
                ...
                <p class="mb-4"> 
                    <span class="text-danger">Pastikan NIK (Nomor Induk Kependudukan) anda terdaftar di kecamatan XX</span> agar bisa melakukan pengaduan pada website pengaduan kecamatan XX. 
                </p>
                
                <h4 class="mb-3">Cara Kerja Website Pengaduan</h4>
                <ol>
                    <li>Isi form pengaduan dengan data diri Anda yang valid, termasuk NIK, nama, alamat, dan nomor telepon.</li>
                    <li>Pastikan NIK Anda sudah terdaftar di database kecamatan untuk dapat mengajukan pengaduan.</li>
                    <li>Setelah mengisi form, tuliskan pengaduan Anda secara jelas dan lengkap di kolom "Isi Pengaduan".</li>
                    <li>Tekan tombol "Kirim Pengaduan" untuk mengirim laporan Anda ke pihak kecamatan.</li>
                    <li>Pihak kecamatan akan memproses laporan Anda, dan Anda bisa memantau status laporan melalui fitur cek status pengaduan.</li>
                </ol>
                <p class="mt-3">Jika Anda memiliki pertanyaan lebih lanjut atau membutuhkan bantuan, jangan ragu untuk menghubungi kami melalui nomor kontak di bawah.</p>
                <div class="mt-4 mt-lg-0 me-lg-n4 py-3 px-4 bg-primary d-flex align-items-center">
                    <div class="d-flex flex-shrink-0 align-items-center justify-content-center bg-white" style="width: 45px; height: 45px;">
                        <i class="fa fa-phone-alt text-primary"></i>
                    </div>
