	...
	<div class="wrapper">
		...
		<div class="main">
          ...
          <i class="hamburger align-self-center"></i>
                ...
                <img src="../assets/img/avatars/avatar.jpg" class="avatar img-fluid rounded me-1" alt="Charles Hall" /> <span class="text-dark"><?= $_SESSION['nama_admin'] ?></span>
              </a>
						...
						<div class="col-xl-12 col-xxl-12">
							<div class="card flex-fill w-100">
								<div class="card-header">
									...
									<h5 class="card-title mb-0">Data Laporan Bulanan</h5>
								</div>
