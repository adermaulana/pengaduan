...
if(isset($_POST['simpan'])){
    $simpan = mysqli_query($koneksi, "INSERT INTO kategori (nama) VALUES ('$_POST[nama]')");
                    ...
                    <form method="post">
                        <div class="row">
                            <div class="col-12 col-lg-6">
                                <div class="card">
                                    <div class="card-body">
                                        <input type="text" class="form-control" name="nama" placeholder="Kategori" required>
                                        <button class="btn btn-success mt-3" type="submit" name="simpan">Tambah</button>
